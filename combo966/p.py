...
COHERE_API_KEY = os.getenv("COHERE_API_KEY")   # for Cohere LLM
...
dark_mode = False
window = tk.Tk()
window.title("Voice Assistant | Whisper STT + Cohere LLM + pyttsx3")
window.geometry("950x620")
window.config(bg="#f2f2f2")

header = tk.Frame(window, height=60, bg="#007acc")
header.pack(fill="x")
tk.Label(header, text="🎤 Whisper STT + Cohere Command-R+ + pyttsx3",
