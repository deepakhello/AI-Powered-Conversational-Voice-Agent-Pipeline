...
# === GUI Setup === 
# ... [PREVIOUS CODE unchanged above this point]

# === GUI Setup (continued) ===
dark_mode = False
window = tk.Tk()
window.title("Voice Assistant | AssemblyAI STT + Gemini Flash + Deepgram TTS")
window.geometry("950x620")
window.config(bg="#f2f2f2")

header = tk.Frame(window, height=60, bg="#007acc")
header.pack(fill="x")
tk.Label(header, text="🎤 AssemblyAI STT + Gemini + Deepgram TTS",
