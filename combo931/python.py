...
def transcribe_deepgram():
    ...
    try:
        ...
        print("🔴 Deepgram STT Exception:", e)
        return None
...
def handle_voice():
    def task():
        ...
        transcript = transcribe_deepgram()
...
dark_mode = False
window = tk.Tk()
window.title("Voice Assistant | Deepgram STT + Gemini + pyttsx3 TTS")
window.geometry("950x620")
window.config(bg="#f2f2f2")

header = tk.Frame(window, height=60, bg="#007acc")
header.pack(fill="x")
tk.Label(header, text="🎤 Deepgram STT + Gemini + pyttsx3",
